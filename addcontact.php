<?php
    ...
    // Below part is done for edit button
    $error_msg = "";
    ...
    // Edit part end this above part is not for addcontact
        ...
        <div class="card">
            ...
            <article class="card-body">
                <form method="POST" action="<?php echo SITEURL . "actions/addcontact_action.php" ?>" enctype="multipart/form-data">
                    <!-- enctype="multipart/form-data" this is necessary to take file as an input because of this 
                        we are able to use input type as file -->
                    <div class="form-row">
